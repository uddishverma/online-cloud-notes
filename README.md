...
An accompanying API now lives in `server/`. It manages authentication and persistent notes storage with SQLite.
...
The database seeds a demo user for quick testing:

- Username: `testuser`
- Password: `password`

Update or remove this seed in `server/src/config/database.js` as needed.
